...
class FrameTest(unittest.TestCase):
    def test_check_exist_ppt(self):
        folder_path = 'D:\\Workspace\\test_model\\video_test\\'
    ...
    def test_frame_fragment(self):
        ...
        with open(frame_fragment_file, 'w') as file:
            for fragment in ppt_fragment:
                ...
                file.write("\n")
        # 按片段保存每帧视频
        picture_folder = 'D:\\Workspace\\test_model\\ppt\\课程资源_ALL\\'
        for fragment in frame_fragment:
            fragment_picture_folder = os.path.join(picture_folder, str(fragment[0]['num']))
